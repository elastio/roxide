...
lazy_static! {
    ...
    static ref ROCKS_DB_TICKER_METRICS: Vec<(&'static str, &'static str)> = vec![
        ...
        ("rocksdb.block.cache.add.redundant", "# of blocks redundantly inserted into block cache"),
        ...
        ("rocksdb.block.cache.compression.dict.add", "Description TBD"),
        ("rocksdb.block.cache.compression.dict.add.redundant", "# of dict blocks redundantly inserted into block cache"),
        ("rocksdb.block.cache.compression.dict.bytes.insert", "Description TBD"),
        ("rocksdb.block.cache.compression.dict.hit", "Description TBD"),
        ("rocksdb.block.cache.compression.dict.miss", "Description TBD"),
        ("rocksdb.block.cache.data.add", "Data blocks added to the RocksDB block cache"),
        ("rocksdb.block.cache.data.add.redundant", "# of data blocks redundantly inserted into block cache"),
        ...
        ("rocksdb.block.cache.filter.add.redundant", "# of filter blocks redundantly inserted into block cache"),
        ...
        ("rocksdb.block.cache.index.add.redundant", "# of index blocks redundantly inserted into block cache"),
        ...
        ("rocksdb.persistent.cache.hit", "Description TBD"),
        ("rocksdb.persistent.cache.miss", "Description TBD"),
        ("rocksdb.row.cache.hit", "Row cache hits"),
        ("rocksdb.row.cache.miss", "Row cache misses"),
        ("rocksdb.secondary.cache.hits", "Description TBD"),
        ("rocksdb.sim.block.cache.hit", "Description TBD"),
        ("rocksdb.sim.block.cache.miss", "Description TBD"),
        ...
        // I/O metrics
        ("rocksdb.async.read.error.count", "Description TBD"),
        ("rocksdb.backup.read.bytes", "Description TBD"),
        ("rocksdb.backup.write.bytes", "Description TBD"),
        ("rocksdb.bytes.read", "Total bytes read"),
        ("rocksdb.bytes.written", "Total bytes written"),
        ("rocksdb.cold.file.read.bytes", "Description TBD"),
        ("rocksdb.cold.file.read.count", "Description TBD"),
        ("rocksdb.db.iter.bytes.read", "Description TBD"),
        ("rocksdb.files.deleted.immediately", "Description TBD"),
        ("rocksdb.files.marked.trash", "Description TBD"),
        ("rocksdb.flush.write.bytes", "Description TBD"),
        ("rocksdb.hot.file.read.bytes", "Description TBD"),
        ("rocksdb.hot.file.read.count", "Description TBD"),
        ...
        ("rocksdb.last.level.read.bytes", "Description TBD"),
        ("rocksdb.last.level.read.count", "Description TBD"),
        ("rocksdb.memtable.garbage.bytes.at.flush", "Outdated bytes of data present on memtable at flush time"),
        ("rocksdb.memtable.hit", "Number of memtable hits"),
        ("rocksdb.memtable.miss", "Number of memtable misses"),
        ("rocksdb.memtable.payload.bytes.at.flush", "Raw bytes of data (payload) present on memtable at flush time"),
        ("rocksdb.non.last.level.read.bytes", "Description TBD"),
        ("rocksdb.non.last.level.read.count", "Description TBD"),
        ("rocksdb.number.db.next", "Description TBD"),
        ("rocksdb.number.db.next.found", "Description TBD"),
        ("rocksdb.number.db.prev", "Description TBD"),
        ("rocksdb.number.db.prev.found", "Description TBD"),
        ("rocksdb.number.db.seek", "Description TBD"),
        ("rocksdb.number.db.seek.found", "Description TBD"),
        ("rocksdb.number.direct.load.table.properties", "Description TBD"),
        ("rocksdb.number.iter.skip", "Description TBD"),
        ("rocksdb.number.merge.failures", "Description TBD"),
        ("rocksdb.number.multiget.bytes.read", "Description TBD"),
        ("rocksdb.number.multiget.get", "Description TBD"),
        ("rocksdb.number.multiget.keys.found", "Number of keys actually found in MultiGet calls (vs number requested by caller)"),
        ("rocksdb.number.multiget.keys.read", "Number of keys requested by caller (vs number actually found)"),
        ("rocksdb.number.rate_limiter.drains", "Description TBD"),
        ("rocksdb.number.reseeks.iteration", "Description TBD"),
        ("rocksdb.number.superversion_acquires", "Description TBD"),
        ("rocksdb.number.superversion_cleanups", "Description TBD"),
        ("rocksdb.number.superversion_releases", "Description TBD"),
        ...
        ("rocksdb.read.async.micros", "Description TBD"),
        ("rocksdb.remote.compact.read.bytes", "Description TBD"),
        ("rocksdb.remote.compact.write.bytes", "Description TBD"),
        ("rocksdb.stall.micros", "Description TBD"),
        ("rocksdb.warm.file.read.bytes", "Description TBD"),
        ("rocksdb.warm.file.read.count", "Description TBD"),
        ("rocksdb.write.other", "Writes done for others"),
        ("rocksdb.write.self", "Writes done for self"),
        ("rocksdb.write.wal", "Writes done to the WAL"),
        ...
        ("rocksdb.number.keys.written", "Number of keys written"),
        ...
        ("rocksdb.compact.read.marked.bytes", "Description TBD"),
        ("rocksdb.compact.read.periodic.bytes", "Description TBD"),
        ("rocksdb.compact.read.ttl.bytes", "Description TBD"),
        ("rocksdb.compact.write.bytes", "Bytes written during compact operations"),
        ("rocksdb.compact.write.marked.bytes", "Description TBD"),
        ("rocksdb.compact.write.periodic.bytes", "Description TBD"),
        ("rocksdb.compact.write.ttl.bytes", "Description TBD"),
        ...
        ("rocksdb.compaction.key.drop.user", "Description TBD"),
        ...
        // Other metrics
        ("rocksdb.block.checksum.compute.count", "Description TBD"),
        ("rocksdb.db.mutex.wait.micros", "Description TBD"),
        ...
        ("rocksdb.multiget.coroutine.count", "Description TBD"),
        ("rocksdb.no.file.errors", "Description TBD"),
        ("rocksdb.no.file.opens", "Description TBD"),
        ("rocksdb.num.iterator.created", "Description TBD"),
        ("rocksdb.num.iterator.deleted", "Description TBD"),
        ("rocksdb.txn.get.tryagain", "Description TBD"),
        ("rocksdb.txn.overhead.duplicate.key", "Description TBD"),
        ("rocksdb.txn.overhead.mutex.old.commit.map", "Description TBD"),
        ("rocksdb.txn.overhead.mutex.prepare", "Description TBD"),
        ("rocksdb.txn.overhead.mutex.snapshot", "Description TBD"),
        ("rocksdb.verify_checksum.read.bytes", "Description TBD"),
    ];
