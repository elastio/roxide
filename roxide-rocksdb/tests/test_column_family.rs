...
use roxide_rocksdb::{TransactionDB, TransactionDBOptions};
use util::DBPath;
...
use roxide_rocksdb::MultiThreaded;
#[cfg(not(feature = "multi-threaded-cf"))]
use roxide_rocksdb::SingleThreaded;
...
fn test_no_leaked_column_family() {
    let n = DBPath::new("_rust_rocksdb_no_leaked_column_family");
    {
        ...
        let mut write_options = roxide_rocksdb::WriteOptions::default();
        ...
        for cf_index in 0..20 {
            ...
            let mut batch = roxide_rocksdb::WriteBatch::default();
