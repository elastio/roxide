...
use roxide_rocksdb::statistics::{Histogram, StatsLevel, Ticker};
use roxide_rocksdb::{
...
fn env_and_dbpaths_test() {
    ...
    let path2 = DBPath::new("_rust_rocksdb_dbpath_test_2");
    {
        ...
        {
            let paths = vec![
                roxide_rocksdb::DBPath::new(&path1, 20 << 20).unwrap(),
                roxide_rocksdb::DBPath::new(&path2, 30 << 20).unwrap(),
            ];
